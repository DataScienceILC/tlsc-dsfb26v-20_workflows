...
We do also still offer an account on the RStudio Server that you used during the previous DSFB1 course. The server can be found [here](daur.rstudio.hu.nl). If you do not have access to your account any more, please inform your teachers. The list of required software can be found here \@ref(softwarelist). 

## Seeking interaction and help
During this course we really invite you to seek interaction on the course contents, the exercises and assignments with fellow course participants and the instructors. **Presence in class is mandatory!** You will be graded partly on class participation.

## Exercises and portfolio

### Normal exercises

Within the lessons you will encounter a number of exercises. Most excercises in the lessons are 'normal' exercises that can be used to learn the skills presented in the lessons. 

### Portfolio assignments

At the end of every lesson (and sometimes in the middle), there is a larger __portfolio assignment__. You will work on this assignment for the rest of the day, after finishing the smaller exercises in the lesson. The collection of all the portfolio assignments will form the main part of your portfolio for this course. The portfolio is also the exam for this course. The details for the portfolio and all the portfolio assignments can be found [here](#portfolio-toetsing). 
...
So, to summarise: to successfully complete this course, you will need to pass these checks:
 ...
 1. Complete your portfolio including all the portfolio assignments before the deadline.
 1. Participate actively in class.
 1. Pass the live assessment that will be held to grade your portfolio.

For more detailed information on the requirements and rules for passing this course see [the page on the portfolio](#portfolio-toetsing).
