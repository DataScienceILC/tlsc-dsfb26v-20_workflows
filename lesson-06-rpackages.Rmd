...
NB: if you create an R package, you need a name. It needs to be unique, especially if you plan on getting your package on CRAN. The `{available}` package can help you evaluate possible names to make sure they do not clash with other names. Use this code to check the name you would like to use:
...
**To pass this assignment, your new package should at least include:**
 ...
 1. At least 4 different functions that you wrote and with proper documentation, using roxygen2 comments
